...
import com.example.ai.gemini.GeminiAdvisorEngine
import com.example.ai.gemini.GeminiAiConsultation
import com.example.ai.mind.PulseMindEngine
...
import com.example.ai.predictor.PulseFeatureExtractor
import com.example.ai.predictor.PulsePrediction
import com.example.ai.predictor.PulsePredictorEngine
import com.example.ai.predictor.RawTelemetryObservation
import com.example.ai.predictor.TelemetryWindow
...
import com.example.data.NetPulsePreferences
import com.example.data.TelemetryObservationEntity
import com.example.engine.DiagnosticEngine
import com.example.engine.DualStackEngine
import com.example.engine.FaultSimulator
import com.example.engine.HopTracerEngine
import com.example.engine.IncidentReportEngine
import com.example.engine.NetworkComparisonEngine
import com.example.engine.NetworkHealerEngine
import com.example.engine.PingMatrixEngine
import com.example.engine.RadarEngine
...
import com.example.model.HealerActionType
...
import com.example.service.NetPulseSentinelService
...
class NetPulseViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun processTelemetryAndInference(
        ...
        val obs = RawTelemetryObservation(
            ...
            wifiRssiDbm = if (snapshot.primaryTransport == com.example.model.NetworkTransport.WIFI) wifiRadar.rssiDbm else null,
