...
import com.example.ai.predictor.PredictorLikelyCause
...
class RuleBasedPulseMind : PulseMindEngine {
    ...
    override suspend fun explain(
        ...
        val confidenceText = when {
            ...
            prediction?.state == com.example.ai.predictor.PredictorState.INSUFFICIENT_TELEMETRY -> "Deterministic diagnostics active (ML buffering telemetry window: ${prediction.stateReason})."
